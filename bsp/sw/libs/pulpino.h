...
#define SOC_PAD_MUX   __PSC__(0x00)
#define SOC_PADCFG0	  __PSC__(0x20)
#define SOC_PADCFG1	  __PSC__(0x24)
#define SOC_PADCFG2	  __PSC__(0x28)
#define SOC_PADCFG3	  __PSC__(0x2C)
#define SOC_PADCFG4	  __PSC__(0x30)
#define SOC_PADCFG5	  __PSC__(0x34)
#define SOC_PADCFG6	  __PSC__(0x38)
#define SOC_PADCFG7	  __PSC__(0x3C)
...
#define DATAEAM_ORIGIN 0x00100000
#define DATARAM_LENGTH 0x6000

#define BOOT_STACK_ORIGIN 0x00105E00
#define BOOT_STACK_LENGTH 0x1f00

#define STACK_ORIGIN 0x00106000
#define STACK_LENGTH 0x2000

#ifdef TARGET_FPGA

#define INSTRRAM_ORIGIN 0x00001000
#define INSTRRAM_LENGTH 0x7000
#define BOOTROM_ORIGIN 0x00000000
#define BOOTROM_LENGTH 0x1000

#elif defined(TARGET_SIMULATION)

#define INSTRRAM_ORIGIN 0x00000000
#define INSTRRAM_LENGTH 0x8000
#define BOOTROM_ORIGIN 0x00080000
#define BOOTROM_LENGTH 0x1000
